defmodule LocalHex.Mirror.HexApi do
  ...
  @callback fetch_hexpm_tarball(LocalHex.Repository.t(), binary, binary) :: {:ok, binary} | {:error, any}
  ...
  def fetch_hexpm_tarball(repository, name, version), do: impl().fetch_hexpm_tarball(repository, name, version)
