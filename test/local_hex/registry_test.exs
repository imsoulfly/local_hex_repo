    ...
    expected_registry = %{
      "example_lib" => [
        ...
        %{
          ...
          outer_checksum:
            <<121, 231, 109, 122, 83, 200, 182, 71, 229, 125, 226, 101, 10, 17, 215, 136, 39, 197,
              161, 170, 236, 120, 58, 136, 29, 14, 221, 121, 44, 191, 121, 100>>,
          version: "0.2.0"
        }
      ]
    }
    ...
    expected_registry = %{
      "another_lib" => [
        %{
          ...
          outer_checksum:
            <<204, 84, 86, 176, 58, 58, 131, 77, 38, 136, 230, 149, 23, 125, 28, 138, 10, 138, 1,
              204, 51, 80, 124, 187, 150, 18, 108, 238, 93, 94, 144, 2>>,
          version: "0.1.0"
        }
      ],
      "example_lib" => [
